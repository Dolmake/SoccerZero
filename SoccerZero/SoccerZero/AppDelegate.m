...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    //We create a Navigation controller container
    UINavigationController* navVC = [[UINavigationController alloc]  initWithNibName:nil bundle:nil];
    
    //The we create the main entry menu
    DLMKMainMenuViewController* mainVC = [[DLMKMainMenuViewController alloc] initWithNibName:nil bundle:nil];
...
- (void)applicationDidEnterBackground:(UIApplication *)application {
    ...
    [[DLMKModelServer SINGLETON] saveData ];
}
